  ...
  <header class="top-bar">
    ...
    <nav>
      <div class="nav-bar left">
        <a class="effectHov" href="../html/ServiceSpanishDM.php"><b>Servicios</b></a>
        <a class="effectHov" href="../html/Noticiasdark.php"><b>Noticias</b></a>
        <a class="effectHov" href="../html/AboutUsDark - Spanish.php"><b>Sobre nosotros</b></a>
      </div>
      <div class="nav-bar right">
        ...
        <a href="../html/ServiceSpanish.php">
