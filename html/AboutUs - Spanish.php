    ...
    <header class="top-bar">
      ...
      <nav>
        <div class="nav-bar leftSP">
          <a class="effectHov" href="ServiceSpanish.php"><b>Servicios</b></a>
          <a class="effectHov" href="Noticiaslight.php"><b>Noticias</b></a>
          <a class="effectHov" href="AboutUs - Spanish.php"
          ...
          <div class="language-menu">
            ...
            <ul class="lang">
              <li>
                ...
                <a href="AboutUs.php">Inglés</a>
              </li>
              <li>
                <img src="../Images/spanish.png" alt="sp" />
                <a href="AboutUs - Spanish.php">Español</a>
              </li>
            </ul>
          </div>
          <a href="AboutUsDark - Spanish.php">
