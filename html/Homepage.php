...
<html lang="en">
  ...
  <body>
    <header class="top-bar">
      ...
      <nav>
        <div class="nav-bar left">
          <a href="../html/service.php"><b>Services</b></a>
          <a href="../html/Newspage.php"><b>News</b></a>
          <a href="../html/AboutUs.php"><b>About Us</b></a>
        </div>
          ...
          <div class="language-menu">
            ...
            <ul class="lang">
              <li>
                ...
                <a href="../html/Homepage.php">English</a>
              </li>
              <li>
                <img src="../Images/spanish.png" alt="sp" />
                <a href="../html/HomepageSP.php">Spanish</a>
              </li>
            </ul>
          </div>
    ...
    <main>
      ...
      <a class="services" href="../html/service.php" alt="service">
        <b>SERVICES</b>
      </a>
